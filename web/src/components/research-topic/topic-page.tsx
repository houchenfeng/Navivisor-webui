...
export function TopicPage() {
  ...
  const runSearch = async () => {
    ...
    try {
      const response = await fetch(withBasePath('/api/research/topic/first-search'), {
        ...
        body: JSON.stringify({ researchInterest: interest.trim(), context: context.trim() || undefined, maxItems: 20 }),
      });
  ...
  return <main className="min-h-0 flex-1 overflow-auto bg-[#a6c7ff] text-[#19386f]">
