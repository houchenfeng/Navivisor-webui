...
export const demoContext = '离线回退：从 Cityscapes、ADE20K 等公开数据集开始，了解语义分割的主流方法和常见评测指标（如 mIoU）。';
...
export const demoTaskSnapshot = {
  ...
  isDemo: true,
  papers: [
    { openalexId: 'https://openalex.org/W639708223', title: 'Faster R-CNN: Towards Real-Time Object Detection with Region Proposal Networks', authors: [], institutions: [], source: 'OpenAlex offline snapshot', publicationYear: 2016, citedByCount: 0, abstract: '公开元数据离线回退条目；摘要未在本地快照中保存。', doi: '10.1109/TPAMI.2016.2577031', landingUrl: 'https://openalex.org/W639708223', sourceStatus: 'openalex_public_api' as const },
    { openalexId: 'https://openalex.org/W2806070179', title: 'Mask R-CNN', authors: [], institutions: [], source: 'OpenAlex offline snapshot', publicationYear: 2017, citedByCount: 0, abstract: '公开元数据离线回退条目；摘要未在本地快照中保存。', doi: '', landingUrl: 'https://openalex.org/W2806070179', sourceStatus: 'openalex_public_api' as const },
    { openalexId: 'https://openalex.org/W4400014661', title: 'Deep Residual Learning for Image Recognition', authors: [], institutions: [], source: 'OpenAlex offline snapshot', publicationYear: 2016, citedByCount: 0, abstract: '公开元数据离线回退条目；摘要未在本地快照中保存。', doi: '', landingUrl: 'https://openalex.org/W4400014661', sourceStatus: 'openalex_public_api' as const },
    { openalexId: 'https://openalex.org/W2995726119', title: 'Identification of Tomato Disease Types and Detection of Infected Areas Based on Deep Convolutional Neural Networks and Object Detection Techniques', authors: [], institutions: [], source: 'OpenAlex offline snapshot', publicationYear: 2019, citedByCount: 0, abstract: '公开元数据离线回退条目；摘要未在本地快照中保存。', doi: '', landingUrl: 'https://openalex.org/W2995726119', sourceStatus: 'openalex_public_api' as const },
  ],
