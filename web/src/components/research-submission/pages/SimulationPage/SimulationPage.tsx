...
import Step5RebuttalLoading from '../../components/steps/Step5RebuttalLoading';
...
export default function SimulationPage() {
  ...
  const renderStep = () => {
    switch (step) {
      case 1: return <Step1OpenReviewHome />;
      case 2: return <Step2VenuePage />;
      case 3: return <Step3SubmissionForm />;
      case 4: return <Step4FirstRoundResult />;
      case 5: return <Step5RebuttalLoading />;
      case 6: return <Step6FinalResult />;
      default: return <Step1OpenReviewHome />;
    }
  };
  return (
