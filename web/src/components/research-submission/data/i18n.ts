...
const zhTexts: Omit<II18nTexts, 'id' | 'lang'> = {
  ...
  guideClickVenue: '点击这里进入投稿 👉', guideClickSubmitBtn: '点击按钮开始投稿 👆', guideAiAssist: '点击 AI 辅助填写试试吧 👉', guideSubmitRebuttal: '写好后点击提交 Rebuttal 👇',
  loading: '加载中...',
};
...
const enTexts: Omit<II18nTexts, 'id' | 'lang'> = {
  ...
  news: 'News', viewAll: 'View all', activeVenues: 'Active Venues', openForSubmissions: 'Open for Submissions', allVenues: 'All Venues', clickToSubmit: 'Click to submit 👉', deadline: 'Deadline',
  goBackHome: '← Go to OpenReview homepage', submissionBtn: 'CVPR 2026 Conference Submission',
  title: 'Title', authors: 'Authors', keywords: 'Keywords', abstract: 'Abstract', write: 'Write', preview: 'Preview', aiAssist: 'AI Assist', generating: 'Generating...', submit: 'Submit', cancel: 'Cancel', submitting: 'Submitting...', track: 'Track', submissionFormat: 'Submission Format / Page Limit', tldr: 'TL;DR', pdfUpload: 'PDF Upload', choosePdf: 'Choose PDF', pdfHint: 'Please upload the paper PDF generated by your writing tool.', pdfTip: '💡 Tip: Upload your paper PDF first, and AI will automatically fill in the title, authors, abstract, and keywords for you.', emailSharing: 'Email Sharing', dataRelease: 'Data Release', license: 'License', readers: 'Readers', signatures: 'Signatures',
  submissionNo: 'Submission', decision: 'Decision', pending: 'Pending', result: 'Result', initialReviewCompleted: 'Reviews have been released. The final acceptance decision will be made by the Area Chair after the rebuttal period, taking into account all reviews and the authors\' response. Please submit your rebuttal before the deadline.', reviews: 'Reviews', reviewer: 'Reviewer', score: 'Score', summary: 'Summary', strengths: 'Strengths', weaknesses: 'Weaknesses', questions: 'Questions', confidence: 'Confidence', rebuttal: 'Rebuttal', submitRebuttal: 'Submit Rebuttal', scoreExplanation: 'Score Explanation', excellent: 'Excellent', good: 'Good', fair: 'Fair', poor: 'Poor', rebuttalNote: 'Note: The three reviewers recommend Accept / Weak Accept / Borderline Accept, with an average score of 5.0 right at the borderline. The final decision is made by the Area Chair after the rebuttal period — a strong Rebuttal can significantly improve your chances of acceptance.', authorRebuttal: 'Author Rebuttal', authorRebuttalDesc: 'Respond to reviewer comments. Be polite, professional, and address every point.', rebuttalTips: 'Rebuttal Tips', rebuttalTip1: 'Thank reviewers for their time and feedback', rebuttalTip2: 'Address EVERY weakness and question from EVERY reviewer', rebuttalTip3: 'Be specific about what you will change in the camera-ready version', rebuttalTip4: 'Do not be defensive — acknowledge valid concerns', rebuttalTip5: 'Keep it concise and well-organized by reviewer', rebuttalEditTip: 'Tip: You can edit this until the rebuttal deadline.', characters: 'characters', disclaimer: 'CVPR Submission Simulator — Educational Demo for First-Year Students. This is a simulation. Not affiliated with OpenReview or CVPR.',
  stepHome: 'Home', stepVenue: 'Venue', stepSubmit: 'Submit', stepReviews: 'Reviews', stepRebuttal: 'Rebuttal', stepDecision: 'Decision',
  reviewing: 'Under review...',
  accepted: 'Accepted', acceptedOral: 'Accepted (Oral)', congratulations: 'Congratulations! Your paper has been accepted as Oral Presentation.', round1Score: 'Round 1 Score', round2Score: 'Round 2 Score', round1Comment: 'Round 1 Comment', round2Comment: 'Round 2 Comment', rebuttalResponse: 'Rebuttal Response', authorFinalRemarks: 'Author Final Remarks', restart: 'Restart Simulation',
  ...
  guideClickVenue: 'Click here to submit 👉', guideClickSubmitBtn: 'Click to start submission 👆', guideAiAssist: 'Try AI Assist 👉', guideSubmitRebuttal: 'Click to submit rebuttal 👇',
  loading: 'Loading...',
};
