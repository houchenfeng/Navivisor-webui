...
const zhTexts: Omit<II18nTexts, 'id' | 'lang'> = {
  ...
  submissionNo: '投稿编号', decision: '决定', pending: '待决定', result: '结果', initialReviewCompleted: '初审已完成。评审意见已发布。最终接收决定将在 Rebuttal 阶段结束后，由领域主席（Area Chair）综合所有评审意见及作者回复后做出。请在截止日期前提交 Rebuttal。', reviews: '评审意见', reviewer: '评审人', score: '评分', summary: '总结', strengths: '优点', weaknesses: '不足', questions: '问题', confidence: '置信度', rebuttal: '作者回复', submitRebuttal: '提交 Rebuttal', scoreExplanation: '评分说明', excellent: '优秀', good: '良好', fair: '一般', poor: '较差', rebuttalNote: '提示：三位评审人给出了审稿意见，最终决定由领域主席（Area Chair）在 Rebuttal 结束后综合做出，一份有力的 Rebuttal 可以明显提高被接收的概率。', authorRebuttal: '作者回复', authorRebuttalDesc: '逐条回应审稿意见。请保持礼貌、专业，并回应每一个问题。', rebuttalTips: 'Rebuttal 写作建议', rebuttalTip1: '感谢审稿人的时间和反馈', rebuttalTip2: '回应每一位审稿人的每一条 weakness 和 question', rebuttalTip3: '具体说明你会在终稿中做哪些修改', rebuttalTip4: '不要防御性反驳——承认合理的担忧', rebuttalTip5: '保持简洁，按审稿人分组组织内容', rebuttalEditTip: '提示：在 Rebuttal 截止日期前你都可以编辑修改。', characters: '字符', disclaimer: 'CVPR 投稿流程练习环境。本网站与 OpenReview 或 CVPR 无关。',
