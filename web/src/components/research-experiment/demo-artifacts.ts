...
export const DEMO_COMPARISON_ROWS: string[][] = [
  ['ConvAE', '74.6', '65.1', '18.7', '-2.2', '-3.1', '—', '—', '46'],
  ['WS-CT', '78.3', '69.8', '23.4', '+1.5', '+1.6', '—', '—', '89'],
  ['CLIP-TSA', '75.9', '66.5', '20.2', '-0.9', '-1.7', '—', '—', '74'],
  ['LAVAD', '78.9', '70.3', '24.6', '+2.1', '+2.1', '40.2', '27.8', '131'],
  ['B0', '76.8', '68.2', '24.1', '0.0', '0.0', '41.5', '26.4', '118'],
